...
<head>
    ...
    <title>Recepcionistas · Clínica UPN</title>
    ...
    <div class="app-shell">
        ...
        <div class="app-main">
            <header class="topbar">
                ...
                <div>
                    <div class="topbar__title">Recepcionistas</div>
                    <div class="topbar__sub">Gestión del personal de recepción</div>
                </div>
                <div class="topbar__spacer"></div>
                <button class="c-btn c-btn--primary" data-modal-open="modalNuevo">
                    <i class="ti ti-plus"></i> Registrar recepcionista
                </button>
            </header>
            ...
            <div class="app-content">
                <div class="c-card">
                    <div class="c-card__head">
                        <div class="c-card__title"><i class="ti ti-headset"></i> Directorio de recepción</div>
                        <span class="muted" style="font-size:13px;">${recepcionistas.size()} registrados</span>
                    </div>
                    <table class="c-table">
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            <c:forEach var="r" items="${recepcionistas}">
                                <tr>
                                    <td class="text-strong">${r.nombre} ${r.apellido}</td>
                                    <td>${r.dni}</td>
                                    <td>${r.telefono != null ? r.telefono : '—'}</td>
                                    <td>
                                        <c:choose>
                                            <c:when test="${r.username != null}"><span class="c-badge c-badge--success"><i class="ti ti-user-check"></i> ${r.username}</span></c:when>
                                    ...
                                    <td>
                                        <div class="table-actions" style="justify-content:flex-end;">
                                            <button class="c-btn c-btn--ghost btn-editar"
                                                    data-id="${r.idRecepcionista}" data-nombre="${r.nombre}"
                                                    data-apellido="${r.apellido}" data-dni="${r.dni}"
                                                    data-telefono="${r.telefono}">
                                                <i class="ti ti-pencil"></i>
                                            </button>
                                            <a class="c-btn c-btn--danger" href="RecepcionistaServlet?accion=eliminar&id=${r.idRecepcionista}"
                                               onclick="return confirm('¿Desactivar a este recepcionista?');">
                            ...
                            <c:if test="${empty recepcionistas}">
                                <tr><td colspan="5" class="muted" style="text-align:center; padding:28px;">Aún no hay recepcionistas registrados.</td></tr>
                            </c:if>
                        </tbody>
                    </table>
                </div>
        ...
        <div class="c-modal__dialog">
            <form action="RecepcionistaServlet" method="POST">
                ...
                <div class="c-modal__head">
                    <div class="c-modal__title"><i class="ti ti-headset"></i> Registrar recepcionista</div>
                ...
                <div class="c-modal__body">
                    ...
                    <div class="field">
                        <label>Vincular cuenta de usuario (rol Recepcionista)</label>
                        ...
                        <div class="hint">Primero crea el usuario con rol Recepcionista en la sección Usuarios.</div>
                    </div>
                </div>
    ...
    <div class="c-modal" id="modalEditar">
        <div class="c-modal__dialog">
            <form action="RecepcionistaServlet" method="POST">
                ...
                <input type="hidden" name="idRecepcionista" id="ed_id">
                <div class="c-modal__head">
                    <div class="c-modal__title"><i class="ti ti-pencil"></i> Editar recepcionista</div>
                    <button type="button" class="c-modal__close" data-modal-close><i class="ti ti-x"></i></button>
                </div>
                <div class="c-modal__body">
                    <div class="form-row">
